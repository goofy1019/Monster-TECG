...
public class CartaSecretos extends Carta {
	...
	protected CartaSecretos(boolean stat, String tip, String nom, String des, int id, int man, Object ef, Object acc) {
	...
	static CartaSecretos Secreto1 = new CartaSecretos(false, "Secreto", "Monster Hunt",
			"Destroy the monster that attacked and negate the attack.", 21, 300, EfectoMonsterHunt(), IncomingAttack());
	static CartaSecretos Secreto2 = new CartaSecretos(false, "Secreto", "Redraw",
			"Opponent has to discard hand and draw four cards.", 22, 50, EfectoRedraw(), IncomingAttack());
	static CartaSecretos Secreto3 = new CartaSecretos(false, "Secreto", "Monster Switch",
	...
	static CartaSecretos Secreto4 = new CartaSecretos(false, "Secreto", "Freeze Defense",
			"Freezes opponent's monsters for two turns.", 24, 300, EfectoFreezeDefense(), IncomingAttack());
	static CartaSecretos Secreto5 = new CartaSecretos(false, "Secreto", "Counterstrike",
			"Make opponent take the damage of their attack.", 25, 200, EfectoCounterstrike(), IncomingAttack());
	static CartaSecretos Secreto6 = new CartaSecretos(false, "Secreto", "Damage Multiplier", "Double your attack next round.",
			26, 100, EfectoDamageMultiplier(), IncomingAttack());
	static CartaSecretos Secreto7 = new CartaSecretos(false, "Secreto", "Shield",
			"Receive half of the damage inflicted by attacking monster.", 27, 100, EfectoShield(), IncomingAttack());
	static CartaSecretos Secreto8 = new CartaSecretos(false, "Secreto", "Blast Shield",
			"Take no damage from opponent's attack.", 28, 250, EfectoBlastShield(), IncomingAttack());
	static CartaSecretos Secreto9 = new CartaSecretos(false, "Secreto", "Last Stand",
			"Attack max. once with every monster you have in play without using any mana.", 29, 200, EfectoLastStand(),
			LowHealth());
	static CartaSecretos Secreto10 = new CartaSecretos(false, "Secreto", "Aether Mumbler",
