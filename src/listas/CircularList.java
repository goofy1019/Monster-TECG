...
public class CircularList {
	...
	public void insertEndE(CartaEsbirros data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertEndH(CartaHechizos data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertEndS(CartaSecretos data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertFirstE(CartaEsbirros data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertFirstH(CartaHechizos data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertFirstS(CartaSecretos data) {
		Node newNode = new Node(data);
		if (this.start == null) {
			newNode.setNext(newNode);
			newNode.setPrev(newNode);
	...
	public void insertAfterE(Node prev_Node, CartaEsbirros data) {
		Node newNode = new Node(data);
		Node temp = this.start;
		while (temp.getData() != prev_Node.getData()) {
			temp = temp.getNext();
	...
	public void insertAfterH(Node prev_Node, CartaHechizos data) {
		Node newNode = new Node(data);
		Node temp = this.start;
		while (temp.getData() != prev_Node.getData()) {
			temp = temp.getNext();
	...
	public void insertAfterS(Node prev_Node, CartaSecretos data) {
		Node newNode = new Node(data);
		Node temp = this.start;
		while (temp.getData() != prev_Node.getData()) {
			temp = temp.getNext();
	...
	public void delNodeE(CartaEsbirros data) {
		if (this.start == null) {
			return;
		}else {
			Node current = this.start;
	...
	public void delNodeH(CartaHechizos data) {
		if (this.start == null) {
			return;
		}else {
			Node current = this.start;
	...
	public void delNodeS(CartaSecretos data) {
		if (this.start == null) {
			return;
		}else {
			Node current = this.start;
